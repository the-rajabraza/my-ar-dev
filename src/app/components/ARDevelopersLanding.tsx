...
export default function ARDevelopersLanding() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        // Append the hidden values manually
                ...
                <main className="pt-20">
                    ...
                    <section id="about" className="py-20">
                        <div className="container mx-auto px-6">
                            <h2 className="text-3xl font-bold text-center mb-12 text-gray-800 dark:text-gray-200 animate-on-scroll">About
                                Us</h2>
                            <div className="flex flex-col md:flex-row items-center justify-between">
                                ...
                                <div className="md:w-1/2 md:pl-12 animate-on-scroll">
                                    <p className="text-lg mb-6 text-gray-600 dark:text-gray-400 leading-relaxed">
                                        ...
                                        technical expertise to deliver outstanding digital solutions for businesses of
                                        all sizes.
                                    </p>
                    ...
                    <section id="services" className="py-20 bg-gray-50 dark:bg-gray-800 transition-colors duration-300">
                        <div className="container mx-auto px-6">
                            <h2 className="text-3xl font-bold text-center mb-16 text-gray-800 dark:text-gray-200 animate-on-scroll">Our
                                Services</h2>
                    ...
                    <section id="testimonials" className="py-20 md:py-32">
                        <div className="container mx-auto px-6">
                            <h2 className="text-3xl font-bold text-center mb-16 text-gray-800 dark:text-gray-200 animate-on-scroll">What
                                Our Clients Say</h2>
                    ...
                    <section id="internship"
                        ...
                        <div className="container mx-auto px-6">
                            ...
                            <h2 className="text-3xl font-bold text-center mb-16 text-gray-800 dark:text-gray-200 animate-on-scroll">Internship
                                Program</h2>
                            <div className="max-w-3xl mx-auto text-center">
                                <p className="text-lg mb-10 text-gray-600 dark:text-gray-400 animate-on-scroll">
                                    Join our internship program to gain hands-on experience in web development and
                                    design.
                                    Work on real projects, learn from industry experts, and kickstart your career in
                                    tech.
                                </p>
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-10">
                                    {[
                                        ...
                                        <div key={index}
                                             className="bg-white dark:bg-gray-700 p-6 rounded-xl shadow-lg animate-on-scroll">
                                            <Image
                    ...
                    <section id="contact" className="py-20">
                        <div className="container mx-auto px-6">
                            <h2 className="text-3xl font-bold text-center mb-16 text-gray-800 dark:text-gray-200 animate-on-scroll">Contact
                                Us</h2>
                                ...
                                {!isSubmitted ? (
                                    <form onSubmit={handleSubmit} className="space-y-6 bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg">
                                        <div className="space-y-2">
                                            <label htmlFor="name"
                                                   className="text-sm font-medium text-gray-700 dark:text-gray-300">Your
                                                Name</label>
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <Input id="email" name="email" type="email" required
                                                   placeholder="john@example.com" className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"/>
                                        </div>

                                        <div className="space-y-2">
                                            <label htmlFor="subject"
                                                   className="text-sm font-medium text-gray-700 dark:text-gray-300">Subject</label>
                                            <Input id="subject" name="subject" type="text"
                                                   placeholder="How can we help you?" className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"/>
                                        </div>
                                        ...
                                        <Button type="submit" className="w-full bg-blue-600 text-white dark:bg-blue-500 dark:text-gray-900 hover:bg-blue-700 dark:hover:bg-blue-400 transition-colors duration-200 text-lg py-3 rounded-full flex items-center justify-center">
                                            {isSubmitting ? 'Sending...' : 'Send Message'} <Mail
                                            className="ml-2 h-5 w-5"/>
                                        </Button>
                                    </form>
                                ) : (
                                    <div
                                        className="text-center py-16 space-y-4 bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg">
                                        <CheckCircle className="w-16 h-16 text-green-500 mx-auto"/>
                                        <h3 className="text-xl font-semibold text-green-600 dark:text-green-400">Thank
                                            You!</h3>
                                        <p className="text-gray-600 dark:text-gray-300">Your message has been sent
                                            successfully.</p>
                                    </div>
                                )}
                            </div>
