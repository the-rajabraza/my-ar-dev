        ...
        <div className={`min-h-screen bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200 font-inter transition-colors duration-300`}>
            ...
            <div className="relative">
                ...
                <main className="pt-20">
                    ...
                    <section id="testimonials" className="py-20 bg-blue-600 dark:bg-blue-800 transition-colors duration-300">
                        <div className="container mx-auto px-6">
                            <h2 className="text-3xl font-bold text-center mb-16 text-white animate-on-scroll">What Our Clients Say</h2>
